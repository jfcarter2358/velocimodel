...
const DEFAULT_CONFIG_PATH = "/home/api-server/data/config.json"
const ENV_PREFIX = "API_SERVER_"

type ConfigObject struct {
	HTTPHost          string      `json:"http_host" env:"HTTP_HOST"`
	HTTPPort          int         `json:"http_port" env:"HTTP_PORT"`
	ServiceManagerURL string      `json:"service_manager_url" env:"SERVICE_MANAGER_URL"`
