...
$(document).ready(
    require(['vs/editor/editor.main'],
        function () {
            ...
            modelJSONString = $("#model-json").text()
            modelJSONFormatted = JSON.stringify(JSON.parse(modelJSONString), null, 4);

            // Editor Config
            model = monaco.editor.createModel(modelJSONFormatted, undefined, monaco.Uri.file('model.json'))
