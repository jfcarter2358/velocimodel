...
const DEFAULT_CONFIG_PATH = "/home/service-manager/data/config.json"
const ENV_PREFIX = "SERVICE_MANAGER"

type ConfigObject struct {
	DB            DBObject    `json:"db" env:"DB"`
	ParamsPath    string      `json:"params_path" env:"PARAMS_PATH"`
	SecretsPath   string      `json:"secrets_path" env:"SECRETS_PATH"`
	EncryptionKey string      `json:"encryption_key" env:"ENCRYPTION_KEY"` // [32]byte
